...
question-bound adjudication and the default Linux peer-credential SQLite service.
...
The only database is the [SQLite Linux service profile](docs/sqlite-profile-v1.md).
...
staged case-queue intake. Existing SQLite installations need the explicit schema upgrade
